...
public class Contagem_SMARTLOGISTICATemplate {
	ArrayList<Box> boxes = new ArrayList<Box>();
	String[] file;
	JSONReader parser = new JSONReader();
	
	public Contagem_SMARTLOGISTICATemplate(String[] file) {
		this.file = file;
	...
	public Box getEmissionDate(String[] file) {
		return parser.valueOnLaterLines(file, "Dt. de Emiss", 8);
	}
	...
	public Box getTakerCNPJ(String[] file) {
		return parser.valueOnLaterLines(file, "CNPJ/CPF", 3);
	}
	...
	public Box getTotalAmount(String[] file) {
		return parser.valueOnSameLine_MultipleWords(file, "Valor Total da NFS-e", " ");
	}
	...
	*/
	public Box getISSValue(String[] file) {
		return parser.valueOnNextLine(file, "Valor Total do ISS", 6);
	}
}
