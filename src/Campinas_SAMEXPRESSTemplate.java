...
public class Campinas_SAMEXPRESSTemplate {
	ArrayList<Box> boxes = new ArrayList<Box>();
	String[] file;
	JSONReader parser = new JSONReader();
	
	public Campinas_SAMEXPRESSTemplate(String[] file) {
		this.file = file;
	...
	public Box getEmissionDate(String[] file) {
		return parser.valueOnNextLine(file, "Data e Hora de Emiss");
	}
	...
	public Box getTakerCity(String[] file) {
		return parser.valueOnSameLine(file, "Munic", ":", 25);
	}
		/*
	...
	public Box getServiceDescription(String[] file) {
		return parser.valueUpToSpecificLine(file, "DISCRIMINA", 8);
	}
